...
def te_permute(
  ...
  # In ring-of-experts mode, disable padding alignment: tokens are already
  # masked to local experts, so padding inflates the buffer through all 3
  # GEMMs and their transposes, causing XLA to pick slower GEMM tilings.
